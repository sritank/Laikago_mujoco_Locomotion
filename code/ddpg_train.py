...
model = DDPG(MlpPolicy2, env, verbose=1, param_noise=param_noise, action_noise=action_noise, render=False, buffer_size=1000000, random_exploration=0.0 )
...
# qpos0_hist=np.ones((1,82))
# model = SAC(MlpPolicy1, env, verbose=1, gamma=0.99, learning_rate=0.0003, buffer_size=50000, learning_starts=100, train_freq=1, batch_size=64, tau=0.005)
...
# model.learn(total_timesteps=9500000, log_interval=100)
# model.save("sac_quad")
